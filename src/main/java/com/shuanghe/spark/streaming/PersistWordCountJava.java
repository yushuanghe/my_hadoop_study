...
import com.shuanghe.util.ConnectionPool;
 ...
 * Description:foreachRDD
 */
public class PersistWordCountJava {
    public static void main(String[] args) {
        SparkSession spark = SparkSession.builder()
                .appName("PersistWordCountJava")
                .master("local[2]")
                .getOrCreate();
        ...
        result.foreachRDD((VoidFunction<JavaPairRDD<String, Integer>>) (rdd -> {
            rdd.foreachPartition((VoidFunction<Iterator<Tuple2<String, Integer>>>) (iterator) -> {
                //给每个partition获取一个连接
