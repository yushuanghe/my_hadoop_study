...
public class GenerateMockData {
    ...
    public static void main(String[] args) {
        ...
        try {
            String file = "C:\\Users\\yushuanghe\\Desktop\\user_visit_action.txt";
         ...
         */
        try {
            String file = "C:\\Users\\yushuanghe\\Desktop\\user_info.txt";
            bw = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(file, true)));
        ...
        try {
            String file = "C:\\Users\\yushuanghe\\Desktop\\product_info.txt";
            bw = new BufferedWriter(new OutputStreamWriter(
                    new FileOutputStream(file, true)));
