package com.shuanghe.sparkproject.spark.page;
        ...
        return sessionid2actionsRDD.flatMapToPair(
                ...
                new PairFlatMapFunction<Tuple2<String, Iterable<Row>>, String, Integer>() {
                    ...
                    public Iterator<Tuple2<String, Integer>> call(
                        ...
                        //对session中的访问行为排序
                        Collections.sort(rows, (Row o1, Row o2) -> {
                            String actionTime1 = o1.getAs("action_time");
                            String actionTime2 = o2.getAs("action_time");
